...
var dayModule = (function () {
    ...
    Day.prototype.addAttraction = function (attraction) {
        ...
        .then(function(addedAttraction){
            doThisAfterServerHasAddedAttraction(addedAttraction);
        })
    ...
    Day.prototype.removeAttraction = function (attraction) {
        ...
        if(whatever === "hotel"){
            ...
            .then(function(toDelete){
                doThisAfterServerHasRemovedAttraction(toDelete)
            })
             ...
             $.ajax({
                method: 'DELETE',
                url: '/days/' + this.id + '/' + whatever + '/' + attraction.id
            })
            .then(function(toDelete){
                doThisAfterServerHasRemovedAttraction(toDelete)
            })
